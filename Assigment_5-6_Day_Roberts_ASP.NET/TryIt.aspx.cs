...
using Assignment_5_6_Day_Roberts_NET_DLL;
using System;
...
namespace Assigment_5_6_Day_Roberts_ASP.NET
{
    public partial class TryIt : System.Web.UI.Page
    {
        ...
        {
            lblHashedPassword.Text = "";
            try
            {
                string hashedPassword = Crypto_NET.Hash(txtPassword.Text);
                lblHashedPassword.Text = hashedPassword;
            }
            catch (Exception ex)
            {
